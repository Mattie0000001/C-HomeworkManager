...
"background: rgb(0, 0, 127);\n"
"color: white;"));
        stuName = new QLineEdit(AddStu);
        stuName->setObjectName(QStringLiteral("stuName"));
        stuName->setGeometry(QRect(350, 20, 301, 31));
        stuID = new QLineEdit(AddStu);
        stuID->setObjectName(QStringLiteral("stuID"));
        stuID->setGeometry(QRect(350, 70, 301, 31));
        ...
        stuName_2 = new QLineEdit(AddStu);
        stuName_2->setObjectName(QStringLiteral("stuName_2"));
        stuName_2->setGeometry(QRect(350, 190, 301, 31));
        ...
        stuName_3 = new QLineEdit(AddStu);
        stuName_3->setObjectName(QStringLiteral("stuName_3"));
        stuName_3->setGeometry(QRect(350, 250, 301, 31));
        ...
        stuName_4 = new QLineEdit(AddStu);
        stuName_4->setObjectName(QStringLiteral("stuName_4"));
        stuName_4->setGeometry(QRect(350, 310, 301, 31));
        ...
        stuName_5 = new QLineEdit(AddStu);
        stuName_5->setObjectName(QStringLiteral("stuName_5"));
        stuName_5->setGeometry(QRect(350, 370, 301, 31));
        ...
        stuName_6 = new QLineEdit(AddStu);
        stuName_6->setObjectName(QStringLiteral("stuName_6"));
        stuName_6->setGeometry(QRect(350, 430, 301, 31));
        QWidget::setTabOrder(stuName, stuID);
